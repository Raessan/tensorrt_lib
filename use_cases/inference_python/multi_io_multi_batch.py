...
path_model_onnx = "../models/multi_io/model_multi_batch.onnx"
...
if __name__ == "__main__":
    ...
    # Take the selected batches
    input1 = input1_all_batches[:batch_size,:]
    input2 = input2_all_batches[:batch_size,:]
    input3 = input3_all_batches[:batch_size,:]
    output1_gt = output1_gt_all_batches[:batch_size,:]
    output2_gt = output2_gt_all_batches[:batch_size,:]

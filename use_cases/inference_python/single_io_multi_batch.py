...
path_model_onnx = "../models/single_io/model_multi_batch.onnx"
...
if __name__ == "__main__":
    ...
    # Take the first batches
    input = input_all_batches[:batch_size,:]
    output_gt = output_gt_all_batches[:batch_size,:]
